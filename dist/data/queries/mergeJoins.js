...
const _mergeJoin = require('../utilities/mergeJoin.js')
const _reconcileJoins = require('../utilities/reconcileJoins.js')
...
const mergeJoins = exports.mergeJoins = /* #__PURE__ */(function () {
    ...
    return _regenerator().w(function (_context) {
      while (1) {
        switch (_context.p = _context.n) {
          case 0:
            dataSet = _args.length > 0 && _args[0] !== undefined ? _args[0] : {}
            merges = _args.length > 1 && _args[1] !== undefined ? _args[1] : []
            if (merges.length) {
              _context.n = 1
              break
            }
          ...
          case 1:
            _iterator = _createForOfIteratorHelper(merges)
            _context.p = 2
            _iterator.s()
          case 3:
            ...
            merge = _step.value
            _context.n = 4
            return (0, _mergeJoin.mergeJoin)(merge.propertyA, merge.propertyB, dataSet)
          case 4:
            dataSet = _context.v
