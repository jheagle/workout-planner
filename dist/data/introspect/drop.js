...
const _retrieveFile = require('../utilities/retrieveFile.js')
    ...
    return _regenerator().w(function (_context) {
      while (1) {
        switch (_context.p = _context.n) {
          ...
          case 1:
            _context.n = 2
            return (0, _retrieveFile.retrieveFile)(''.concat(record, '.json'))
          case 2:
          ...
          case 4:
            ...
            file = _step.value
            _context.n = 5
            return rm(''.concat(databasePath).concat(recordFile.path, '/').concat(file))
          case 5:
            _context.n = 4
            break
          case 6:
