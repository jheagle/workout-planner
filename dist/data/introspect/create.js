...
const _field = require('./definitions/field.js')
    ...
    return _regenerator().w(function (_context) {
      while (1) {
        switch (_context.n) {
          ...
          case 1:
            if (!(0, _testFilesystem.fileExists)(''.concat(databasePath).concat(record, '.json'))) {
              _context.n = 2
              break
            }
            return _context.a(2, null)
          case 2:
            ...
            _context.n = 3
            return writeFile(''.concat(databasePath).concat(record, '.json'), JSON.stringify(recordContent, null, 2))
          case 3:
            _context.n = 4
            return mkdir(''.concat(databasePath).concat(record), {
              recursive: true
            })
          case 4:
