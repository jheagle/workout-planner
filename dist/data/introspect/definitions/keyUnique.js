...
const _retrieveRecords = require('../../utilities/retrieveRecords.js')
...
const keyUnique = exports.keyUnique = /* #__PURE__ */(function () {
  const _ref = _asyncToGenerator(/* #__PURE__ */_regenerator().m(function _callee (entity) {
    let references
    let checkKey
    let records
    let found
    ...
    return _regenerator().w(function (_context) {
      while (1) {
        switch (_context.n) {
          case 0:
            references = _args.length > 1 && _args[1] !== undefined ? _args[1] : []
            checkKey = _args.length > 2 && _args[2] !== undefined ? _args[2] : null
          ...
          case 1:
            _context.n = 2
            return (0, _retrieveRecords.retrieveRecords)(entity)
          case 2:
            records = _context.v
            found = (0, _where.where)(records, {
              property: references[0],
              comparator: '=',
              value: checkKey
            })
            return _context.a(2, !found.length)
        }
      }
    }, _callee)
  }))
  return function keyUnique (_x) {
