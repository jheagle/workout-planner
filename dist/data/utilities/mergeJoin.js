...
const mergeJoin = exports.mergeJoin = /* #__PURE__ */(function () {
  const _ref = _asyncToGenerator(/* #__PURE__ */_regenerator().m(function _callee () {
    ...
    return _regenerator().w(function (_context) {
      while (1) {
        switch (_context.n) {
          case 0:
            propertyA = _args.length > 0 && _args[0] !== undefined ? _args[0] : ''
            propertyB = _args.length > 1 && _args[1] !== undefined ? _args[1] : ''
          ...
          case 4:
            dataSets[entityA] = dataSets[entityA].map(function (dataA) {
              ...
              for (const prop in mergeMatch) {
                ...
                dataA[''.concat(entityB, '.').concat(prop)] = mergeMatch[prop]
              }
              return dataA
            })
