...
const _retrieveFile = require('./retrieveFile.js')
...
const retrieveRecords = exports.retrieveRecords = /* #__PURE__ */(function () {
    ...
    return _regenerator().w(function (_context) {
      while (1) {
        switch (_context.p = _context.n) {
          case 0:
            entity = _args.length > 0 && _args[0] !== undefined ? _args[0] : ''
            _context.n = 1
            return (0, _retrieveFile.retrieveFile)(''.concat(entity, '.json'))
          case 1:
            recordFile = _context.v
            dataSet = []
            _iterator = _createForOfIteratorHelper(recordFile.entries)
            _context.p = 2
            _iterator.s()
          case 3:
            ...
            file = _step.value
            _context.n = 4
            return (0, _retrieveFile.retrieveFile)(''.concat(recordFile.path, '/').concat(file)).catch(function (err) {
          ...
          case 4:
            ...
            throw new Error('Could not read entity '.concat(file))
          case 5:
            dataSet.push(data)
          case 6:
            _context.n = 3
          ...
          case 9:
            ...
            return _context.f(9)
          case 10:
            return _context.a(2, dataSet)
        }
      }
    }, _callee, null, [[2, 8, 9, 10]])
  }))
  return function retrieveRecords () {
